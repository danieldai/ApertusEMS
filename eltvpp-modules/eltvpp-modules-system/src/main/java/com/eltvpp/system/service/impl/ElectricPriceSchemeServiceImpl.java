...
import com.eltvpp.system.mapper.ElectricPriceSchemeMapper;
...
public class ElectricPriceSchemeServiceImpl implements IElectricPriceSchemeService {
     ...
     */
    @Override
    public ElectricPriceScheme checkEffectYearUnique(Long deptId, Long id) {
        return electricPriceSchemeMapper.checkEffectYearUnique(deptId, id);
    }
}
