...
import com.eltvpp.system.service.ISysPermissionService;
import com.eltvpp.system.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    public AjaxResult getInfo() {
        ...
        if (user != null) {
            user.setHeadPic(StringUtils.setHeadpic(fileDomain, user.getId(), user.getHeadPic()));
        }
