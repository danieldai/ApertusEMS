...
import com.eltvpp.system.mapper.SysGroupMapper;
import com.eltvpp.system.service.IPublicService;
import com.eltvpp.system.service.ISysCommonDictService;
import com.eltvpp.system.service.ISysGroupService;
...
public class SysGroupServiceImpl implements ISysGroupService {
     ...
     */
    @Override
    public void autoGenPvGroupSync(Long parentId, Long deptId) {
        System.out.println("执行C1：" + DateUtils.getTime());
