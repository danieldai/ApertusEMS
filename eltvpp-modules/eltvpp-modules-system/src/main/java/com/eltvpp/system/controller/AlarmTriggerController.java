...
import com.eltvpp.system.domain.AlarmTrigger;
import com.eltvpp.system.domain.AlarmTriggerCategory;
...
import com.eltvpp.system.domain.jsonvo.ChartYAxisVo;
import com.eltvpp.system.service.*;
...
public class AlarmTriggerController extends BaseController {
    ...
    public AjaxResult getLevelStaticList(Integer stationType, String beginTime, String endTime) {
    ...
    public AjaxResult getCategoryStaticList(Integer stationType, String beginTime, String endTime) {
        AlarmTrigger alarmTrigger = new AlarmTrigger();
        alarmTrigger.setStationType(stationType);
        alarmTrigger.setParams(DateUtils.dateToParamForDayFormat(beginTime, endTime));
