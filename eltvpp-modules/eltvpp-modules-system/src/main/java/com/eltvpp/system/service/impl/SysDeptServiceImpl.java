...
import com.eltvpp.common.core.text.Convert;
...
import com.eltvpp.system.domain.vo.TreeSelect;
import com.eltvpp.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService {
     ...
     */
    @Override
    public Boolean autoGenDeptSync() {
        System.out.println("执行B1："+ DateUtils.getTime());
        ...
        for (SysCommonEnterprise enterprise : entStationList) {
            ...
            int rows;
            SysDept dept_ent_old = deptMapper.selectDeptByDeptSn(enterprise.getEntSn());
            if (dept_ent_old == null) {
                rows = deptMapper.insertDept(dto);
            } else {
                dto.setId(dept_ent_old.getId());
        ...
        System.out.println("执行B2："+ DateUtils.getTime());
        return true;
    }
    ...
    private SysDept convertEnterprise(SysCommonEnterprise enterprise) {
        ...
        sysDept.setOrderNum(Integer.parseInt(enterprise.getId() + ""));
