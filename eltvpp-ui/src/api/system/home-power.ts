...
export function getChart(params: any) {
  return axios.get("/datav2/power/chart/getChart", {
    params,
...
export function getStackChart(params: any) {
  ...
  return axios.get("/datav2/power/chart/getStackChart", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function getPageValueList(pageSign: string) {
  ...
  return axios.get("/datav2/power/chart/getPageValueList", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function getChartBySingleDate(params: any) {
  return axios.get("/datav2/power/chart/getChartBySingleDate", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function getChartByDoubleDate(params: any) {
  return axios.get("/datav2/power/chart/getChartByDoubleDate", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function ppfvList(params: any) {
  return axios.get("/datav2/power/chart/ppfvList", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function basicDataList(params: any) {
  return axios.get("/datav2/power/chart/basicDataList", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function getEnergySteamDate(params: any) {
  return axios.get("/datav2/power/chart/getEnergySteamDate", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
...
export function getAuxiliaryAnalysis(params: any) {
  return axios.get("/datav2/power/chart/getAuxiliaryAnalysis", {
    params,
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
