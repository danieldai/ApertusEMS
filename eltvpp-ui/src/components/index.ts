...
import YkiteFullScreenContainer from '@/components/datav-full-screen-container/index.vue'
// 卡片-基础
...
// 专用模板-报警统计-饼图
import CardChartPieStatistics from "@/components/public/card-chart-pie-statistics/index.vue";
// 大屏-状态图
