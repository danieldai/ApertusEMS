  ...
  <div>
    <a-card class="content">
      ...
      <a-table row-key="id" ref="tableRef" :loading="loading"
               :bordered="{ wrapper: true, cell: true }" :scroll="{ x: 1270 }" :columns="(columns as TableColumnData[])"
               :data="renderData"
    ...
    <a-modal :width="800" v-model:visible="modelVisible" @ok="handleClose" hide-cancel>
      ...
      <div style="height: 500px" v-if="modelVisible">
        ...
        <component :is="previewData.staticType == 1 ? 'card-chart-pie-statistics' : previewData.staticType == 2 ? 'card-chart-combine' : EnumChartType[previewData.chartType]"
                   :public="previewData"
                   style="margin-top: 0">
        </component>
      </div>
...
const handlePreview = (record: any) => {
  ...
  console.log('public', previewData.value)
